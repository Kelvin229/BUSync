...
import com.cosc3p97project.busync.controller.MessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            if (extras.containsKey("visit_user_id")) {
                messageReceiverID = Objects.requireNonNull(extras.get("visit_user_id")).toString();
            }
            if (extras.containsKey("visit_user_name")) {
                messageReceiverName = Objects.requireNonNull(extras.get("visit_user_name")).toString();
            }
            if (extras.containsKey("visit_image")) {
                messageReceiverImage = Objects.requireNonNull(extras.get("visit_image")).toString();
            }
        }
